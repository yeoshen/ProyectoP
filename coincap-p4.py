...
for currency in data:
    ...
    trillion7price_string = '$' + \
        locale.format_string('%.2f', trillion7price, True)
    trillion36price_string = '$' + \
        locale.format_string('%.2f', trillion36price, True)
    trillion73price_string = '$' + \
        locale.format_string('%.2f', trillion73price, True)
    trillion90price_string = '$' + \
        locale.format_string('%.2f', trillion90price, True)
    trillion217price_string = '$' + \
        locale.format_string('%.2f', trillion217price, True)
    trillion544price_string = '$' + \
        locale.format_string('%.2f', trillion544price, True)
